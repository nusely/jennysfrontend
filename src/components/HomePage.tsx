  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="flex flex-col lg:flex-row items-start justify-between px-4 sm:px-6 py-2 max-w-7xl mx-auto min-h-screen">
        {/* Left Column */}
        <div className="flex-1 lg:pr-8 space-y-4 lg:space-y-6">
          ...
          {/* Product Carousel Group - Shifted up */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Navigation Menu - Shifted up more */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            {/* Right Column - Secondary Product Group - Stretched down */}
            <motion.div
